<?php
    //No tocar nada, es un sistema gestor de base de datos que facilita la consulta de información en la DB
        ...
        public static function sql($query){
            ...
            if ($mysqli->connect_errno) {
                ...
                if(!$con = $mysqli->query($query)){
                    echo "Error de sintaxis en la consulta solicitada $query";
                    $mysqli->rollback();  
                }else{
                    $mysqli->commit();
                }
